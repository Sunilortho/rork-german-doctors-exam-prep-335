...
export const VOICE_PROFILES: VoiceProfile[] = [
  // Female voices using 'shimmer' - warm, natural conversational voice
  {
    id: 'female_young',
    name: 'Anna',
    gender: 'female',
  ...
  // Male voices using 'onyx' - deep, natural male voice
  {
    id: 'male_young',
    name: 'Thomas',
    gender: 'male',
    ...
    pitch: 1.0,
    rate: 1.0,
    description: 'Young man, natural conversational voice',
  },
  {
    id: 'male_middle',
    name: 'Klaus',
    ...
    pitch: 1.0,
    rate: 1.0,
    description: 'Middle-aged man, warm conversational voice',
  },
  {
    id: 'male_elderly',
    name: 'Heinrich',
    ...
    pitch: 1.0,
    rate: 1.0,
    description: 'Elderly man, calm conversational voice',
  },
];
...
export function processTextForNaturalSpeech(
  ...
  _personality: 'anxious' | 'talkative' | 'brief'
): string {
  // Keep text natural - OpenAI TTS handles natural delivery
  // Don't inject artificial hesitations that sound robotic when read
  return text;
}
