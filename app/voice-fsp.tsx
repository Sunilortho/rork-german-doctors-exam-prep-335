...
export default function VoiceFSPScreen() {
  ...
  const speakWithExpoSpeech = async (
    ...
    try {
      ...
      const finalPitch = patientGender === 'male' ? 0.75 : 1.5;
